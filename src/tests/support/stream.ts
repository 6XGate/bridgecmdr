...
import type { CommandStream } from '../../main/helpers/stream.js'
import { raiseError } from '@/error-handling.js'
...
export function commandStreamModule(context: MockStreamContext) {
  return async (original: () => Promise<typeof import('../../main/helpers/stream.js')>) => {
