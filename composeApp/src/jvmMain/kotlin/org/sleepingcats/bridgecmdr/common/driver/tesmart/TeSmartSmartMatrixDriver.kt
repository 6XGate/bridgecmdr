...
import bridgecmdr.composeapp.generated.resources.driver_tesmart_matrix
...
val TeSmartSmartMatrixDriver =
  DriverModule.define {
    id = Uuid.parseHexDash("01B8884C-1D7D-4451-883D-3C8F18E17B14")
    kind = DriverKind.Switch
    title = getString(Res.string.driver_tesmart_matrix)
